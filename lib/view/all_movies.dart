...
class _AllMoviesState extends State<AllMovies> {
  AllMoviesViews _allMovies=AllMoviesViews();
  @override
  void initState() {

    _allMovies.fetchMoviesListApi();
  ...
  Widget build(BuildContext context) {
    ...
    return 
      Scaffold(
        body: ChangeNotifierProvider<AllMoviesViews>(
          create: (BuildContext context)=> _allMovies,
          child: Consumer<AllMoviesViews>(
